...
int SD_F469::read(void *b, bd_addr_t addr, bd_size_t size)
{
...
int SD_F469::program(const void *b, bd_addr_t addr, bd_size_t size)
{
...
bd_size_t SD_F469::get_read_size() const
{
    return _read_size;
}

bd_size_t SD_F469::get_program_size() const
{
    return _program_size;
}

bd_size_t SD_F469::get_erase_size() const
{
    return _erase_size;
}
